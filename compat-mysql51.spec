...
were created using EL6 MySQL 5.1.x.
...
%changelog
* Wed Feb  2 2013 Johnny Hughes <johnny@centos.org> 5.1.67-2
- update to 5.1.67
- modified to use the nodocs source as mysql.info is not freely distributable
- added Patch17 for CVE-2012-5611
